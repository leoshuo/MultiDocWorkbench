import { Trash2, RefreshCw, X, Save, RotateCcw, LogOut, Archive } from 'lucide-react';
                    ...
                    deletedButtons.map(btn => (
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                <button
                                    onClick={() => {
                                        if (confirm('确定要永久删除这个按钮吗？此操作无法撤销。')) {
            ...
            {/* Footer */}
            {
                deletedButtons.length > 0 && (
                    <div style={{
                        ...
                        <button
                            onClick={() => {
                                if (confirm('确定要清空回收站吗？所有按钮将永久丢失。')) {
                                    onClearAll();
                                }
                            }}
