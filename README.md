...
### v1.6.6 更新亮点
- **应用端执行逻辑简化**：移除所有定制化处理，统一执行路径，代码更简洁可靠
- **耗时统计功能**：执行完成后显示总耗时（毫秒/秒/分钟自动切换）
- **Bug 修复**：更正 API 路径，消除 404 错误
...
*Document Workspace 1.6.6 - 智能文档处理与经验沉淀平台*
